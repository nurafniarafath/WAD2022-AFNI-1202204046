...
<nav class="navbar navbar-expand-sm bg-primary navbar-dark p-3">
        ...
        <div class="dropdown">
            <button type="button" class="btn btn-light text-primary dropdown-toggle" data-toggle="dropdown">nama</button>
...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col">
                <b><h1><p class="fw-bold">Selamat Datang Di Show Room Afni</p></h1></b>
            ...
            <div class="col">
                <br><br><img src="logo-ead.png"  style="width: 100px;px;height: 25px;px;"><a> AFNI_1202204046</a>
            </div>
            </div> 
            <div class="col">
                <img src="ayla.jpg" style="width:600px;height:380px;">
            </div>  
        </div>
    </div>
    </div>
